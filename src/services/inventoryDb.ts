...
export const DEFAULT_BRANDS_LIST = [
  'Addam Adulto', 'Addam Infantil', 'Adidas', 'Amora Maria', 'Aramis', 'Azaleia', 'Bebecê', 'Beira Rio', 'Bottero', 'Boxx 200 Infantil', 'brSport', 'Calvest', 'Campesí', 'Carreiro', 'Chuteira Joma', 'Chuteira Penalty', 'Coca-Cola', 'Comfortflex', 'Dakota', 'Democrata', 'Dray', 'Ferracini', 'Fila', 'Freeway', 'Gofer', 'Isadora Oliveira', 'Itapuã', 'Kemo Adulto', 'Kemo Infantil', 'Kenner Adulto', 'Kenner Infantil', 'Kidy', 'Klin', 'Kolosh', 'Leveterapia', 'Lynd', 'Maria Isabel', 'Mariotta', 'Mathaus', 'Mini Sua Cia', 'Mississipi', 'Mizuno', 'Modare', 'Moleca', 'Molekinha', 'Molekinho', 'New Balance', 'Nike', 'Olympikus', 'Pampili', 'Ped Shoes', 'Piccadilly', 'Princes', 'Puma', 'QIX', 'Rafithy', 'Ramarim', 'Rainha', 'Rekoba', 'Rissato', 'Skechers', 'Soft Works', 'Society Quadra Joma', 'Society Quadra Penalty', 'Society Sintético Joma', 'Society Sintético Penalty', 'Sua Cia', 'Topper Adulto', 'Under Armour', 'Usaflex', 'Vans', 'Via Marte', 'Via Scarpa', 'Vizzano', 'West Coast', 'World Colors', 'Zebu'
];
